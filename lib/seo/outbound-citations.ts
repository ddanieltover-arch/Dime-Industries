...
export const OUTBOUND_BY_KEY: Record<string, readonly OutboundCitation[]> = {
  ...
  "dime-disposable-vapes": [CA_CANNABIS, FDA_VAPING, MA_CANNABIS],
  "dime-vape-heat-settings": [FDA_VAPING, CA_CANNABIS, MA_CANNABIS],
  "signature-vs-balanced": [CA_CANNABIS, MA_CANNABIS, LEAFLY_STRAIN_HUB],
  "dime-gummies": [CA_CANNABIS, MA_CANNABIS, SAMHSA],
  "find-dime-new-york": [CA_CANNABIS, MA_CANNABIS, SAMHSA],
