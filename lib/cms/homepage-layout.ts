  ...
  sections: [
    {
      id: "hero",
      enabled: true,
      headline: "DIME Industries",
      body: "Award-winning DIME carts, vapes, edibles, and prerolls — engineered hardware and lab-tested extracts for licensed markets.",
      ctaLabel: "Shop DIME carts",
      ctaHref: "/shop/vapes",
    },
