...
export default async function BitcoinPaymentPage({ params }: { params: Params }) {
  ...
  const wallet = getBitcoinWalletAddress();
  const placeholder = isPlaceholderBitcoinWallet(wallet);
  ...
  return (
    <div className="mx-auto max-w-3xl px-[var(--container-pad-x)] py-14 lg:py-20">
      <p className="font-[var(--font-display)] text-[10px] uppercase tracking-[0.18em] text-[var(--color-resin)]">
        {paid ? "Payment confirmed" : "Bitcoin payment"}
      </p>
      <h1 className="section-title mt-3">
        {paid ? "Thank you" : "How to pay with Bitcoin"}
      </h1>
      <p className="mt-4 text-[var(--scale-sm)] text-[var(--color-ink-soft)]">
        Order <span className="text-[var(--color-ink)]">{order.id}</span>
        {paid
          ? " is confirmed."
          : ` · Send exactly ${formatPrice(order.totalCents)} in Bitcoin to the wallet below.`}
      </p>

      {!paid ? (
        <>
          <section className="mt-10 border border-[var(--color-resin)] bg-[rgba(201,177,56,0.08)] p-5 sm:p-7">
            <p className="font-[var(--font-display)] text-[10px] uppercase tracking-[0.16em] text-[var(--color-resin)]">
              Our Bitcoin wallet
            </p>
            <p className="mt-4 break-all font-[var(--font-mono)] text-[var(--scale-sm)] leading-relaxed text-[var(--color-ink)] sm:text-[var(--scale-base)]">
              {wallet}
            </p>
            {placeholder ? (
              <p className="mt-3 text-[var(--scale-xs)] text-[var(--color-ink-muted)]">
                Placeholder address — replace with your live wallet via{" "}
                <span className="text-[var(--color-ink)]">PAYMENT_BTC_WALLET_ADDRESS</span>.
              </p>
            ) : null}
            <div className="mt-5 flex flex-wrap gap-3">
              <CopyWalletButton address={wallet} />
            ...
            <p className="mt-4 text-[var(--scale-xs)] text-[var(--color-ink-muted)]">
              ...
              . Network fees are paid by you — send the full order total in BTC.
            </p>
          </section>
          ...
          <section className="mt-12 space-y-8">
            <div>
              ...
              <p className="mt-3 text-[var(--scale-sm)] text-[var(--color-ink-soft)]">
                ...
                , a secure third-party platform, so you can buy Bitcoin with a card and send it to
                our wallet automatically. DIME never stores your card information.
              </p>
            </div>
            ...
            <ol className="space-y-6">
              <li className="border border-[var(--color-border)] bg-[var(--color-surface)] p-5">
                ...
                <p className="mt-2 text-[var(--scale-sm)] text-[var(--color-ink-soft)]">
                  ...
                  (or your confirmation email) for the wallet address and total.
                </p>
              </li>
              ...
              <li className="border border-[var(--color-border)] bg-[var(--color-surface)] p-5">
                ...
                <ol className="mt-3 list-decimal space-y-2 pl-5 text-[var(--scale-sm)] text-[var(--color-ink-soft)]">
                  ...
                  <li>Paste the Bitcoin address shown at the top of this page.</li>
              ...
              <li className="border border-[var(--color-border)] bg-[var(--color-surface)] p-5">
                ...
                <p className="mt-2 text-[var(--scale-sm)] text-[var(--color-ink-soft)]">
                  After Paybis confirms your send, click <strong className="text-[var(--color-ink)]">I have paid</strong>{" "}
                  above. Our team will verify the transfer and approve your order manually.
                  Payments are usually confirmed within about 30 minutes once the Bitcoin arrives.
                </p>
              </li>
            </ol>
            ...
            <div className="border border-[var(--color-border)] bg-[var(--color-surface-raised)] p-5 text-[var(--scale-sm)] text-[var(--color-ink-soft)]">
              ...
              <p className="mt-2">
                ...
                Bitcoin to the wallet address on this page.
              </p>
              <p className="mt-2">
                Need help? Contact{" "}
