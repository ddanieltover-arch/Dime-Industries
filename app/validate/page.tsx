...
const STEPS = [
  {
    ...
    body: "Find the validation panel on your package and scratch it fully so every character is readable.",
  },
  {
    title: "Enter & verify",
    body: "Type the code below. Catalog SKUs also work for demo verification until the live host is connected.",
  },
  {
    title: "Unlock benefits",
    body: "Confirm authenticity, activate limited warranty coverage, and earn toward Rewards when you sign in.",
  },
] as const;
...
const PERKS = [
  {
    title: "Authenticity",
    body: "Confirm your product is real DIME — not a counterfeit lookalike.",
    href: "/lab-results",
    label: "Lab results",
  },
  {
    title: "Limited warranty",
    body: "Activate the no-hassle warranty path for eligible hardware issues.",
    href: "/legal/returns",
    label: "Returns policy",
  },
  {
    title: "Rewards credit",
    body: "Sign in after validating to sync loyalty points and member perks.",
    href: "/rewards",
    label: "Join rewards",
  },
] as const;
      ...
      <section className="relative isolate min-h-[min(72vh,640px)] overflow-hidden">
        ...
        <div className="relative mx-auto flex min-h-[min(72vh,640px)] max-w-7xl flex-col justify-end px-[var(--container-pad-x)] pb-14 pt-28 sm:pb-20 sm:pt-32">
          ...
          <p className="validate-rise mt-4 max-w-md text-[var(--scale-base)] leading-relaxed text-white/80 [animation-delay:140ms]">
            Verify authenticity and activate your limited warranty — then unlock rewards when you sign in.
          </p>
      ...
      >
        <div className="mx-auto max-w-7xl px-[var(--container-pad-x)] py-[var(--section-y)]">
          ...
          <p className="mt-3 max-w-lg text-[var(--scale-sm)] text-[var(--color-ink-soft)]">
            Every DIME product is backed by a limited &ldquo;no hassle&rdquo; warranty once registered.
          </p>

          <ol className="mt-10 grid gap-px bg-[var(--color-border)] sm:grid-cols-3" role="list">
